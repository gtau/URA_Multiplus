...
public class MN_InformaSaldo extends com.avaya.sce.runtime.Prompt {
	...
	public void buildPrompt(){
		...
		if ( new com.avaya.sce.runtime.Condition( "condition", "WSSaldoParticipante:saldoPontos", com.avaya.sce.runtime.Expression.IS_EMPTY, null ).evaluate(getSession()) == true ) {
			...
			format.add("Number Type","integer");
			format.add("inflection","Nn");
			add(1, new com.avaya.sce.runtime.PromptElement(com.avaya.sce.runtime.PromptElement.VARIABLE_AUDIO,"WSSaldoParticipante:pontosExpiracao",format,false));
