...
public class WSGerarAtendimentos extends com.avaya.sce.runtime.BasicServlet {
	...
	public void servletImplementation(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		String descricao = mySession.getVariable("WSGerarAtendimento").getComplexVariable().getField("descricao").getStringValue();
		...
		try {
			response = api.apiExecute(numeroMultiplus, referenciaTipoAtendimento, referenciaAreaAtendimento, referenciaSubareaAtendimento, descricao, referenciaCanal, referenciaSubcanal, referenciaSituacao, idAtendimento, endpoint, certificado);
		} catch (Exception e) {
