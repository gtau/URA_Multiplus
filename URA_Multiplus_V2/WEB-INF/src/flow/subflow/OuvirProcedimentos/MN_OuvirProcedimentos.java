...
public class MN_OuvirProcedimentos extends com.avaya.sce.runtime.Menu {
	 ...
	 * Last generated by Orchestration Designer at: 3 DE MAIO DE 2016 17H37MIN13S BRT
	...
	public java.util.Collection getEvents(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		event = new com.avaya.sce.runtime.Event(com.avaya.sce.runtimecommon.SCERT.EVENT_NOINPUT, (String[])eventPromptNames.toArray(new String[0]), new com.avaya.sce.runtime.Goto("OuvirProcedimentos-VerificaTentativa", 0, true, ""));
		list.add(event);

		// Item has no prompts associated
		eventPromptNames = new java.util.ArrayList();

		event = new com.avaya.sce.runtime.Event(com.avaya.sce.runtimecommon.SCERT.EVENT_NOMATCH, (String[])eventPromptNames.toArray(new String[0]), new com.avaya.sce.runtime.Goto("OuvirProcedimentos-VerificaTentativa", 0, true, ""));
		list.add(event);
	...
	public java.util.Collection getPrompts(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add("MN_OuvirProcedimentos");
