...
public class MN_InformaSaldo extends com.avaya.sce.runtime.Prompt {
	...
	public void buildPrompt(){
		...
		if ( new com.avaya.sce.runtime.Condition( "condition", "WSConsultarSaldoParticipante:saldoPontos", com.avaya.sce.runtime.Expression.IS_EMPTY, null ).evaluate(getSession()) == true ) {
			...
			format.add("gender","Nn");
			format.add("inflection","Nnn");
			add(1, new com.avaya.sce.runtime.PromptElement(com.avaya.sce.runtime.PromptElement.VARIABLE_AUDIO,"WSConsultarSaldoParticipante:saldoPontos",format,false));
			...
			format.add("gender","Nn");
			format.add("inflection","Nnn");
			add(1, new com.avaya.sce.runtime.PromptElement(com.avaya.sce.runtime.PromptElement.VARIABLE_AUDIO,"WSConsultarSaldoParticipante:pontosExpiracao",format,false));
			...
			format.add("datetype","DMSPD");
			add(1, new com.avaya.sce.runtime.PromptElement(com.avaya.sce.runtime.PromptElement.VARIABLE_AUDIO,"WSConsultarSaldoParticipante:dataExpiracao",format,false));
			add(1, new com.avaya.sce.runtime.PromptElement(com.avaya.sce.runtime.PromptElement.PHRASESET,"FrasesMultiplus:31b",false));
			add(1, new com.avaya.sce.runtime.PromptElement(com.avaya.sce.runtime.PromptElement.PHRASESET,"FrasesMultiplus:VoltarMenuInicial",false));
			add(1, new com.avaya.sce.runtime.PromptElement(com.avaya.sce.runtime.PromptElement.PHRASESET,"FrasesMultiplus:FalarOp",false));
			add(1, new com.avaya.sce.runtime.PromptElement(com.avaya.sce.runtime.PromptElement.PHRASESET,"FrasesMultiplus:SemDuvida",false));
