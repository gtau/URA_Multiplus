...
public class Start extends com.avaya.sce.runtime.Entry {
	...
	public void initializeVariables(com.avaya.sce.runtimecommon.SCESession session) {
		...
		variableFields = new String[] {
			IProjectVariables.MENU_INFORMACOES_SENHA_FIELD_CONFIDENCE,
			IProjectVariables.MENU_INFORMACOES_SENHA_FIELD_INPUTMODE,
			IProjectVariables.MENU_INFORMACOES_SENHA_FIELD_INTERPRETATION,
			IProjectVariables.MENU_INFORMACOES_SENHA_FIELD_NOINPUTCOUNT,
			IProjectVariables.MENU_INFORMACOES_SENHA_FIELD_NOMATCHCOUNT,
			IProjectVariables.MENU_INFORMACOES_SENHA_FIELD_UTTERANCE,
			IProjectVariables.MENU_INFORMACOES_SENHA_FIELD_VALUE };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.MENU_INFORMACOES_SENHA, variableFields, null, session, false, false );
		session.putVariable(variable);
		...
		variableFields = new String[] {
			IProjectVariables.MENU_NOVA_SENHA_RESGATE_FIELD_CONFIDENCE,
			IProjectVariables.MENU_NOVA_SENHA_RESGATE_FIELD_INPUTMODE,
			IProjectVariables.MENU_NOVA_SENHA_RESGATE_FIELD_INTERPRETATION,
			IProjectVariables.MENU_NOVA_SENHA_RESGATE_FIELD_NOINPUTCOUNT,
			IProjectVariables.MENU_NOVA_SENHA_RESGATE_FIELD_NOMATCHCOUNT,
			IProjectVariables.MENU_NOVA_SENHA_RESGATE_FIELD_UTTERANCE,
			IProjectVariables.MENU_NOVA_SENHA_RESGATE_FIELD_VALUE };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.MENU_NOVA_SENHA_RESGATE, variableFields, null, session, false, false );
		session.putVariable(variable);
		...
		variableFields = new String[] {
			IProjectVariables.MENU_NOVA_SENHA_ACESSO_FIELD_CONFIDENCE,
			IProjectVariables.MENU_NOVA_SENHA_ACESSO_FIELD_INPUTMODE,
			IProjectVariables.MENU_NOVA_SENHA_ACESSO_FIELD_INTERPRETATION,
			IProjectVariables.MENU_NOVA_SENHA_ACESSO_FIELD_NOINPUTCOUNT,
			IProjectVariables.MENU_NOVA_SENHA_ACESSO_FIELD_NOMATCHCOUNT,
			IProjectVariables.MENU_NOVA_SENHA_ACESSO_FIELD_UTTERANCE,
			IProjectVariables.MENU_NOVA_SENHA_ACESSO_FIELD_VALUE };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.MENU_NOVA_SENHA_ACESSO, variableFields, null, session, false, false );
		session.putVariable(variable);
