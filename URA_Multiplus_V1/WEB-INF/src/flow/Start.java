...
public class Start extends com.avaya.sce.runtime.Entry {
	...
	public void initializeVariables(com.avaya.sce.runtimecommon.SCESession session) {
		...
		variableFields = new String[] {
			IProjectVariables.MN__TAM_FIELD_CONFIDENCE,
			IProjectVariables.MN__TAM_FIELD_INPUTMODE,
			IProjectVariables.MN__TAM_FIELD_INTERPRETATION,
			IProjectVariables.MN__TAM_FIELD_NOINPUTCOUNT,
			IProjectVariables.MN__TAM_FIELD_NOMATCHCOUNT,
			IProjectVariables.MN__TAM_FIELD_UTTERANCE,
			IProjectVariables.MN__TAM_FIELD_VALUE };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.MN__TAM, variableFields, null, session, false, false );
		session.putVariable(variable);
