 ...
 * Last generated by Orchestration Designer at: 16 DE ABRIL DE 2016 18H58MIN28S BRT
 */
public class AN_ErroCPF extends com.avaya.sce.runtime.Form {
	...
	public java.util.Collection getPrompts(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.PromptRefInfo("AN_ErroCPF", ""));
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("ValidacaoMultiplus-ColetaCPFNumMultiplus");
		return submit;
	}
	/**
