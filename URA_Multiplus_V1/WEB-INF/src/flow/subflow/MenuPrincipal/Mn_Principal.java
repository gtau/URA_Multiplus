...
public class Mn_Principal extends com.avaya.sce.runtime.Menu {
	 ...
	 * Last generated by Orchestration Designer at: 16 DE ABRIL DE 2016 16H14MIN38S BRT
	...
	public java.util.Collection getChoices(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		choice = new com.avaya.sce.runtime.Choice("3", "3", true, "exact", "MenuPrincipal-MenuPontos", grammarInfo, true);
		list.add(choice);
		...
		choice = new com.avaya.sce.runtime.Choice("4", "4", true, "exact", "MenuPrincipal-MenuTAM", grammarInfo, true);
		list.add(choice);
		...
		choice = new com.avaya.sce.runtime.Choice("5", "5", true, "exact", "MenuPrincipal-MenuInformacoesMultiplus", grammarInfo, true);
		list.add(choice);
		...
		choice = new com.avaya.sce.runtime.Choice("9", "9", true, "exact", "MenuPrincipal-SetaRetorno", grammarInfo, true);
		list.add(choice);
