...
public class Mn_Principal extends com.avaya.sce.runtime.Menu {
	...
	public java.util.Collection getChoices(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		choice = new com.avaya.sce.runtime.Choice("3", "3", true, "exact", "MenuPrincipal-Encerra", grammarInfo, true);
		list.add(choice);
		...
		choice = new com.avaya.sce.runtime.Choice("4", "4", true, "exact", "MenuPrincipal-Encerra", grammarInfo, true);
		list.add(choice);
		...
		choice = new com.avaya.sce.runtime.Choice("5", "5", true, "exact", "MenuPrincipal-Encerra", grammarInfo, true);
		list.add(choice);
		...
		choice = new com.avaya.sce.runtime.Choice("9", "9", true, "exact", "MenuPrincipal-Encerra", grammarInfo, true);
		list.add(choice);
