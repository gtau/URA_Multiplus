 ...
 * Last generated by Orchestration Designer at: 16 DE ABRIL DE 2016 14H26MIN23S BRT
 */
public class AN_MenuPrincipalPort extends com.avaya.sce.runtime.Form {
	...
	public java.util.Collection getPrompts(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.PromptRefInfo("MenuPrincipalPort", ""));
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("MenuPrincipal-Mn_Principal");
		return submit;
	}
	/**
