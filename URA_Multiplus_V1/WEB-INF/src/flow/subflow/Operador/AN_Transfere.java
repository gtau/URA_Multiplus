 ...
 * Last generated by Orchestration Designer at: 23 DE ABRIL DE 2016 0H55MIN54S BRT
 */
public class AN_Transfere extends com.avaya.sce.runtime.Form {
	...
	public java.util.Collection getPrompts(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.PromptRefInfo("AN_Transfere", ""));
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("Operador-PreencheUUI");
		return submit;
	}
	/**
