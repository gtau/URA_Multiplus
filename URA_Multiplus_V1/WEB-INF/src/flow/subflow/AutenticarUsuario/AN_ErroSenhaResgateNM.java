 ...
 * Last generated by Orchestration Designer at: 20 DE ABRIL DE 2016 16H12MIN47S BRT
 */
public class AN_ErroSenhaResgateNM extends com.avaya.sce.runtime.Form {
	...
	public java.util.Collection getPrompts(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.PromptRefInfo("AN_ErroSenhaResgateNM", ""));
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("AutenticarUsuario-ColetaSenhaResgate");
		return submit;
	}
	/**
