 ...
 * Last generated by Orchestration Designer at: 20 DE ABRIL DE 2016 16H9MIN21S BRT
 */
public class AN_ErroSenhaResgateNI extends com.avaya.sce.runtime.Form {
	...
	public java.util.Collection getPrompts(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		list.add(new com.avaya.sce.runtime.PromptRefInfo("AN_ErroSenhaResgateNI", ""));
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("AutenticarUsuario-Retorno");
		return submit;
	}
	/**
